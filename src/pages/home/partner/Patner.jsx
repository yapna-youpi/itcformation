...
const Patner = () => {
  return (
    <div>
        <div className="pb-16 pt-14" style={{fontFamily: 'Lato'}}>
            {/* <dh-component> */}
                <div className="container mx-auto pt-16">
                    <div className="w-11/12 xl:w-2/3 lg:w-2/3 md:w-2/3 mx-auto sm:mb-10 mb-16">
                        <h1 tabIndex="0" className="focus:outline-none xl:text-5xl md:text-3xl text-xl text-center text-gray-800 font-extrabold mb-5 pt-4">Partenariats avec des marques convoitées</h1>
                        <p tabIndex="0" className="focus:outline-none text-base md:text-lg lg:text-xl text-center text-gray-600 font-normal xl:w-10/12 xl:mx-auto">
                        Notre succès est dû à notre engagement envers la propriété et à notre investissement dans le développement du produit afin de maximiser les ventes. Tout en maintenant l'intégrité.</p>
                    </div>
