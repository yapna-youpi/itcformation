            ...
            <div className="form mb-5 md:mb-0">
                <form >
                    <div className="form-group bg-white flex items-center py-3 pl-1 md:pl-4   shadow-dark-400/40">
                        ...
                        <button  className='button-newsletter w-2/12 md:w-4/12 ml-0 flex items-center font-semibold hover:text-limer hover:duration-500 '><i className='mx-2'><UilTelegramAlt/> </i> S'INSCRIRE</button>
                    </div>
                </form>
